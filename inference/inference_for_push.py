...
parser.add_argument('--infer_output_path', type=str, required=True, help="Path to the output")
...
with open(infer_output_path, "w", encoding="utf-8") as f:
    for ind, i in enumerate(data):
        ...
        with torch.inference_mode():
            generate_ids = model.generate(**inputs.to(model.device), max_new_tokens=256)
